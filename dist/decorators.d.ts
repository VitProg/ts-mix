...
export declare function use<Mixins extends Array<Mixin<string, AnyObject>>>(...mixins: Mixins): <T extends Constructor<Record<string, any>>>(this: unknown, ctor: T) => Constructor<InstanceType<T> & Pick<import("./common.types").MergeAll<Mixins>, Exclude<keyof import("./common.types").MergeAll<Mixins>, "mixinName" | "target" | "init">> & {
