...
declare function applyMixins<T extends AnyObject, Mixins extends Array<Mixin<any, any>>>(target: T, ...mixins: Mixins): void;

export { AnyMixin, AnyMixinRecord, ArrayValues, IMixinAfterInitHandler, IMixinBase, IUseMixins, Mixin, MixinAssertError, MixinFull, MixinTarget, MixinsProp, UnionToIntersection, applyMixins, assertHaveMixin, assertHaveMixins, haveMixin, haveMixins, isMixin, mixin, useMixins, useMixinsForObject };
